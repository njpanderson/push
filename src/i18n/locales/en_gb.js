module.exports = {
	...
	'no_service_file': 'A service file could not be found within your project. Have you created a file matching "${1}" yet?',
	'couldnt_save_service_file': 'The service file could not be saved to "${1}". The error was: "${2}"',
	'service_file_not_in_workspace': 'The service file at "${1}" is not within the current workspace root and it cannot be saved.',
	'service_file_saved': 'Service file was saved to "${1}".',
	...
	'continue': 'Continue',
	'opt_sftp_hostname': 'Hostname or IP',
	'opt_sftp_port': 'Port',
	'opt_sftp_port_desc': 'Usually 22 for SFTP connections',
	'opt_sftp_username': 'Username',
	...
	'opt_sftp_debug': 'Debug mode',
	'opt_sftp_filemode': 'File mode(s)',
	'opt_sftp_glob': 'Glob',
	'opt_sftp_mode': 'Mode',
	'opt_file_root': 'Root path',
	'opt_base_tz_offset': 'Time zone offset (hours)',
	'opt_base_test_time_diff': 'Test time difference on collisions',
	'opt_base_action_upload': 'Action on upload collisions',
	'opt_base_stop': 'Stop',
	'opt_base_skip': 'Skip',
